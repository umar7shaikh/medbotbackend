...
TRANSLATIONS = {
    ...
    'es': {
        'welcome': "¡Bienvenido a nuestro sistema de programación de citas! Le ayudaré a reservar una cita con el especialista adecuado. Seleccione la categoría que mejor describa su problema médico:",
        'select_subcategory': "Gracias. Seleccione el problema específico que está experimentando relacionado con {}:",
        'specific_location': "¿Este {} está en una ubicación específica?",
        'yes': "Sí",
        'no': "No",
        'select_location': "Seleccione la ubicación:",
        'recommend_doctor': "Según sus selecciones, recomendamos ver a un especialista en {} que pueda ayudar con {}. Seleccione un médico:",
        'recommend_doctor_with_location': "Según sus selecciones, recomendamos ver a un especialista en {} que pueda ayudar con {} en el {}. Seleccione un médico:",
        'select_date': "Seleccione una fecha preferida para su cita con el Dr. {}:",
        'available_slots': "El Dr. {} tiene los siguientes horarios disponibles el {}:",
        'contact_info': "Proporcione su información de contacto para completar la reserva de su cita:",
        'full_name': "Nombre completo",
        'phone_number': "Número de teléfono",
        'email_address': "Dirección de correo electrónico",
        'appointment_confirmed': "¡Gracias! He programado su cita con el Dr. {} ({}) el {} a las {} para {}. Recibirá un correo electrónico de confirmación en breve.",
        'anything_else': "¡Su cita ha sido confirmada! ¿Hay algo más que le gustaría saber sobre su próxima cita?"
    },
    'fr': {
        'welcome': "Bienvenue dans notre système de prise de rendez-vous ! Je vais vous aider à prendre rendez-vous avec le bon spécialiste. Veuillez sélectionner la catégorie qui décrit le mieux votre problème médical :",
        'select_subcategory': "Merci. Veuillez sélectionner le problème spécifique que vous rencontrez en rapport avec {} :",
        'specific_location': "Ce {} est-il situé à un endroit précis ?",
        'yes': "Oui",
        'no': "Non",
        'select_location': "Veuillez sélectionner l'emplacement :",
        'recommend_doctor': "Sur la base de vos sélections, nous recommandons de consulter un spécialiste {} qui peut aider avec {}. Veuillez sélectionner un médecin :",
        'recommend_doctor_with_location': "Sur la base de vos sélections, nous recommandons de consulter un spécialiste {} qui peut aider avec {} dans le {}. Veuillez sélectionner un médecin :",
        'select_date': "Veuillez sélectionner une date préférée pour votre rendez-vous avec le Dr {} :",
        'available_slots': "Le Dr {} a les créneaux horaires disponibles suivants le {} :",
        'contact_info': "Veuillez fournir vos coordonnées pour finaliser la réservation de votre rendez-vous :",
        'full_name': "Nom complet",
        'phone_number': "Numéro de téléphone",
        'email_address': "Adresse e-mail",
        'appointment_confirmed': "Merci ! J'ai programmé votre rendez-vous avec le Dr {} ({}) le {} à {} pour {}. Vous recevrez bientôt un e-mail de confirmation.",
        'anything_else': "Votre rendez-vous a été confirmé ! Y a-t-il autre chose que vous aimeriez savoir sur votre prochain rendez-vous ?"
    },
    'de': {
        'welcome': "Willkommen in unserem Terminplanungssystem! Ich helfe Ihnen, einen Termin mit dem richtigen Spezialisten zu vereinbaren. Bitte wählen Sie die Kategorie aus, die Ihr medizinisches Anliegen am besten beschreibt:",
        'select_subcategory': "Danke. Bitte wählen Sie das spezifische Problem aus, das Sie im Zusammenhang mit {} haben:",
        'specific_location': "Befindet sich dieser {} an einem bestimmten Ort?",
        'yes': "Ja",
        'no': "Nein",
        'select_location': "Bitte wählen Sie den Standort aus:",
        'recommend_doctor': "Aufgrund Ihrer Auswahl empfehlen wir Ihnen, einen {} Spezialisten aufzusuchen, der bei {} helfen kann. Bitte wählen Sie einen Arzt aus:",
        'recommend_doctor_with_location': "Aufgrund Ihrer Auswahl empfehlen wir Ihnen, einen {} Spezialisten aufzusuchen, der bei {} im {} helfen kann. Bitte wählen Sie einen Arzt aus:",
        'select_date': "Bitte wählen Sie ein bevorzugtes Datum für Ihren Termin mit Dr. {} aus:",
        'available_slots': "Dr. {} hat am {} die folgenden verfügbaren Termine:",
        'contact_info': "Bitte geben Sie Ihre Kontaktdaten an, um die Terminbuchung abzuschließen:",
        'full_name': "Vollständiger Name",
        'phone_number': "Telefonnummer",
        'email_address': "E-Mail-Adresse",
        'appointment_confirmed': "Vielen Dank! Ich habe Ihren Termin mit Dr. {} ({}) am {} um {} Uhr für {} vereinbart. Sie erhalten in Kürze eine Bestätigungs-E-Mail.",
        'anything_else': "Ihr Termin wurde bestätigt! Gibt es noch etwas, was Sie über Ihren bevorstehenden Termin wissen möchten?"
    },
    'zh': {
        'welcome': "欢迎使用我们的预约系统！我将帮助您预约合适的专科医生。请选择最能描述您医疗问题的类别：",
        'select_subcategory': "谢谢。请选择您遇到的与{}相关的具体问题：",
        'specific_location': "这个{}是在特定位置吗？",
        'yes': "是",
        'no': "否",
        'select_location': "请选择位置：",
        'recommend_doctor': "根据您的选择，我们建议您咨询可以帮助解决{}问题的{}专科医生。请选择医生：",
        'recommend_doctor_with_location': "根据您的选择，我们建议您咨询在{}可以帮助解决{}问题的{}专科医生。请选择医生：",
        'select_date': "请选择您与{}医生预约的日期：",
        'available_slots': "{}医生在{}有以下可用的时间段：",
        'contact_info': "请提供您的联系信息以完成预约：",
        'full_name': "全名",
        'phone_number': "电话号码",
        'email_address': "电子邮件地址",
        'appointment_confirmed': "谢谢！我已为您预约了{}医生（{}）在{}的{}时间看{}。您将很快收到确认邮件。",
        'anything_else': "您的预约已确认！关于即将到来的预约，您还有其他想了解的吗？"
    },
    'ru': {
        'welcome': "Добро пожаловать в нашу систему записи на прием! Я помогу вам записаться на прием к нужному специалисту. Пожалуйста, выберите категорию, которая лучше всего описывает вашу медицинскую проблему:",
        'select_subcategory': "Спасибо. Пожалуйста, выберите конкретную проблему, связанную с {}:",
        'specific_location': "Это {} находится в определенном месте?",
        'yes': "Да",
        'no': "Нет",
        'select_location': "Пожалуйста, выберите местоположение:",
        'recommend_doctor': "На основании вашего выбора мы рекомендуем обратиться к специалисту по {}, который может помочь с {}. Пожалуйста, выберите врача:",
        'recommend_doctor_with_location': "На основании вашего выбора мы рекомендуем обратиться к специалисту по {}, который может помочь с {} в {}. Пожалуйста, выберите врача:",
        'select_date': "Пожалуйста, выберите предпочтительную дату для вашего приема у доктора {}:",
        'available_slots': "Доктор {} имеет следующие доступные временные интервалы {}:",
        'contact_info': "Пожалуйста, предоставьте вашу контактную информацию для завершения записи на прием:",
        'full_name': "Полное имя",
        'phone_number': "Номер телефона",
        'email_address': "Адрес электронной почты",
        'appointment_confirmed': "Спасибо! Я записал вас на прием к доктору {} ({}) {} в {} для {}. Вы скоро получите подтверждение по электронной почте.",
        'anything_else': "Ваш прием подтвержден! Хотите ли вы узнать что-то еще о предстоящем приеме?"
    },
    'pt': {
        'welcome': "Bem-vindo ao nosso sistema de agendamento de consultas! Vou ajudá-lo a marcar uma consulta com o especialista adequado. Por favor, selecione a categoria que melhor descreve a sua preocupação médica:",
        'select_subcategory': "Obrigado. Por favor, selecione o problema específico que está enfrentando relacionado a {}:",
        'specific_location': "Este {} está em um local específico?",
        'yes': "Sim",
        'no': "Não",
        'select_location': "Por favor, selecione o local:",
        'recommend_doctor': "Com base nas suas seleções, recomendamos consultar um especialista em {} que pode ajudar com {}. Por favor, selecione um médico:",
        'recommend_doctor_with_location': "Com base nas suas seleções, recomendamos consultar um especialista em {} que pode ajudar com {} no {}. Por favor, selecione um médico:",
        'select_date': "Por favor, selecione uma data preferencial para sua consulta com o Dr. {}:",
        'available_slots': "O Dr. {} tem os seguintes horários disponíveis em {}:",
        'contact_info': "Por favor, forneça suas informações de contato para completar o agendamento da sua consulta:",
        'full_name': "Nome completo",
        'phone_number': "Número de telefone",
        'email_address': "Endereço de e-mail",
        'appointment_confirmed': "Obrigado! Agendei sua consulta com o Dr. {} ({}) no dia {} às {} para {}. Você receberá um e-mail de confirmação em breve.",
        'anything_else': "Sua consulta foi confirmada! Há mais alguma coisa que gostaria de saber sobre sua próxima consulta?"
    }
}
